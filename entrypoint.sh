...
ARGO_AUTH='{"AccountTag":"3c9f05a1e43de4e10b88cef38056a8ee","TunnelSecret":"qutQs21uYolZPTLjnkGVsxzvrUAZPy0hEgQ9CLDb8LU=","TunnelID":"848590aa-d40b-42d7-a6a5-069afbfe3891"} ' # Argo 固定域名隧道的两个参数,这个可以填 Json 内容或 Token 内容，获取方式看 https://github.com/fscarmen2/X-for-Glitch，不需要的话可以留空，删除或在这三行最前面加 # 以注释
ARGO_DOMAIN=ussolar6otho.600318.xyz
